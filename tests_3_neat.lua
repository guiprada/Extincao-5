...
ghost_state_reset_on_autoplayer_capture = true
ghost_sequential_home = true
ghost_shuffle_try_order = true
...
autoplayer_neat_specie_niche_initial_population_size = 100
autoplayer_neat_specie_niche_population_history_size = 50
autoplayer_neat_specie_mule_start = false
autoplayer_specie_all_roulette_start = true
autoplayer_neat_specie_threshold = 3
autoplayer_neat_negative_weight_and_activation = true
autoplayer_neat_input_proportional_activation = false

autoplayer_start_idle = true
autoplayer_start_on_center = false
autoplayer_ann_mode = b1
autoplayer_ann_layers = {{count = 12, activation_function_name = "identity"}, {activation_function_name = "tanh"}, {count = 1, activation_function_name = "binary_step"}}
__autoplayer_ann_initial_bias = 0
__autoplayer_ann_initial_weights = 0
__autoplayer_ann_random_spread = 1
autoplayer_fitness_mode = movement_captures_hack_26
__autoplayer_collision_purge = false
__autoplayer_rotate_purge = false
autoplayer_initial_random_population_size = 300
autoplayer_active_population = 1
autoplayer_population_history_size = 100
...
autoplayer_ann_layers = {{count = 4, activation_function_name = "identity"}, {activation_function_name = "tanh"}, {count = 1, activation_function_name = "binary_step"}}
__autoplayer_ann_initial_bias = 0
__autoplayer_ann_initial_weights = 0
__autoplayer_ann_random_spread = 1
autoplayer_fitness_mode = movement_captures_hack_26
...
autoplayer_ann_layers = {{count = 12, activation_function_name = "identity"}, {activation_function_name = "relu"}, {count = 4, activation_function_name = "identity"}}
__autoplayer_ann_initial_bias = 0
__autoplayer_ann_initial_weights = 0
__autoplayer_ann_random_spread = 1
autoplayer_fitness_mode = movement_captures_hack_26
...
autoplayer_ann_layers = {{count = 4, activation_function_name = "identity"}, {activation_function_name = "relu"}, {count = 1, activation_function_name = "identity"}}
__autoplayer_ann_initial_bias = 0
__autoplayer_ann_initial_weights = 0
__autoplayer_ann_random_spread = 1
autoplayer_fitness_mode = movement_captures_hack_26
